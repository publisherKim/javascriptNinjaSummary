...
# 픽셈 점 기반 이미지를 단색화 하여 선기반 이미지로 변경
- 충실도 낮은 사진 선택
- 확장
...
- 한국 문학 근현대사...
- 근데 또 엉뚱한걸 가져감 ㅋㅋㅋ
- 확실히 최종 컨텐츠 생산자에는 관심이 없긴함
- 일러스트레이터 ux 포토샵이랑 많이 비슷해졌네
- 일러스트레이터의 효과나 저장 불러오기 이런쪽에 관심이 생김
- 툴을 제작하는 쪽에 관심이감
- 콘텐츠 생산자는 확실히 아니긴 함...
- 콘텐츠는 소비해야 ㅠㅠ
- 일러스트 테크닉 강의는 무의미한데...
- 확실히 아티스트 유형은 아님 더구나 그림쪽으로는...
- 확실히 외관에는 관심도가 굉장히 낮음
- 양키들 자산 활용이 좋음
- 편집감독 롤
  - 주제 선정
  - 테크닉
...
- 풀테크니션 강사라고 볼수도 있음
- 편집 까지 해야함
- 개발자로 치면 풀스택 개발자에 비슷함
- 모든걸 다 코어에서 개발하진 않지만 컨텐츠 관련해서 1인이 혼자서 다 작업함
- 음악으로 치면 싱어송 라이터
- 확실히 강의는 녹화해서 제공해야 함
- 한번의 학습으로 절대 처음 듣는 사람이 천재가 아닌 이상은 가져 갈수 없음
- 인간은 반복학습을 통해서 기억을 강화함
- 열심히 사는 사람들에겐 그 노하우가 좋은 소리가 날수 밖에 없음
- 일종의 비슷한 파장 같은게 말과 행동에서 나옴